...
public class A1Q6 {
    public static void main(String[] args) {
        ...
        Book book = new Book("Java Course", "Hemant Jain", 500);
        Magazine magazine = new Magazine("Abstraction Inheritance Encapsulation", "Various Teachers", "January 2024");
        DVD dvd = new DVD("Ritikh Edits", "Ritikh", 136);
